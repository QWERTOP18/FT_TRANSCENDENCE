    ...
    const contentHTML = `
        <div class="metallic-card p-8 rounded-lg text-white max-w-2xl mx-auto">
            ...
            <div class="bg-gray-800 bg-opacity-80 border border-gray-600 p-4 rounded-lg mb-6">
                <h4 class="text-blue-300 font-semibold mb-2">⚠️ 注意</h4>
                <p class="text-sm text-gray-200">トーナメントを開始すると、新しい参加者の追加ができなくなります。</p>
                ${tournamentData.participants && tournamentData.participants.length < 2 ? 
                    '<p class="text-sm text-red-300 mt-2 font-semibold">⚠️ 最低2人以上の参加者が必要です。</p>' : 
                    '<p class="text-sm text-green-300 mt-2 font-semibold">✅ 参加者数が十分です。</p>'
                }
            </div>
