        ...
        <div class="metallic-card p-8 rounded-lg text-white max-w-2xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <div class="bg-gray-700 p-4 rounded-lg">
                    <p class="text-sm text-gray-400 mb-2">${t('nowstate')}<span class="text-yellow-400">${tournamentData.state}</span></p>
                    <p class="text-sm text-gray-400 mb-2">${t('memberCount')}${tournamentData.participants?.length || 0} / ${tournamentData.max_num}</p>
                    <p class="text-sm text-gray-400">${t('rule')}${tournamentData.rule}</p>
                </div>
            </div>
